...
export class DadosService {
    ...
    public legenda_edit_ligada : boolean = false;
    public legenda_detail_ligada : boolean = false;
    public classe_legenda_edit : string = 'legenda_desligada';
    public classe_legenda_detail : string = 'legenda_desligada';
    ...
    private applyfilters(parametro, filter_records : any = null) {
        ...
        // if(parametro=='FINANCEIRO' && rule == false){
        //     console.log("FILTRANDO FINANCEIRO PARA ACHAR embreve")
        //
        //     let xtemp = [];
		// 	for(let i in this.filtered_financeiro){
        //         if(!this.filtered_financeiro[i].embreve){
        //             xtemp.push(this.filtered_financeiro[i]);
        //         }
        //         else{
        //             console.log("EM BREVE!!!")
        //             console.log(this.filtered_financeiro[i])
        //         }
        //     }
        //     this.filtered_financeiro = xtemp;
        // }
    }

...
export class UtilService {
  ...
  public getDateObjFromObj(o : any) : any {
      let d = new Date(Number(o.ano), Number(o.mes)-1, Number(o.dia)+0, Number(o.hora)+0, Number(o.minutos)+0, 0, 0).getTime();
      return this.getDateObj(d);
  }

  public getDateObjFromMomentObj(m : any) : any {
      let str = m.format();
      return this.getDateObjFromMomentStr(str);
  }

  public getDateObjFromMomentStr(str : string) : any {
  ...
  public myMoment (param : number = 0) : string {
      let d = this.getDateObj(param);
      return d.momentformat;
  }

  public getDateObjFromDataHora(str : string) : any {
  ...
  public quando_data() : string {
      return this.getDateObj().data;
  }

  public quando_datahora() : string {
      return this.getDateObj().datahora;
  }

  public quando_com_segundos() : string {
      // TODO - O ideal é que a função getDateObj() seja private
      return this.getDateObj().datahora_com_segundos;
  }
  ...
  public formata_data_de_quando_em_milisegundos(quando) {
      ...
      return this.getDateObj(quando).datahora_com_segundos.substr(0,10);
  }

  public formata_data_de_quando_em_milisegundos_com_minutos_e_segundos(quando) {
      // Input = Um valor inteiro representando o número de milisegundos desde 1 de Janeiro de 1970
      return this.getDateObj(quando).datahora_com_segundos.substr(0,16);
  }

  public getMesDeNascimento(nascimento : string = '') : string {
      if(!nascimento) {
          return '';
      }
      nascimento = this.formata_data(nascimento);
      return nascimento.substr(3,2);
  }
      ...
      if(data == undefined) {
          ...
          if (data.length == 10) {
              ...
              if (data.length == 6) {
                  ...
                  let ano_atual = Number(this.getDateObj().ano);
  ...
  public mudou_nascimento(nascimento : string) {
      nascimento = this.formata_data(nascimento)
      this.TEMP.idade = this.get_idade_str(nascimento);
      return nascimento;
  }
  ...
  public get_idade(data : any) : number {
      if( (data == undefined) || (data == '')  || (data == 0) ) {
          ...
          let nascimento = new Date(this.getDateObjFromDataHora(data).quando);
          let hoje = new Date();
  ...
  public get_idade_str(data : string) : string {
  ...
  public get_idade_meses_dias(data : any) : string {
      if( (data == undefined) || (data == '')  || (data == 0) ) {
          ...
          let data_quando = this.getDateObjFromDataHora(data).quando;
          let hoje_quando =    this.getDateObjFromDataHora(hoje).quando;
  ...
  public pad(num : any, size : number) {
      if(size == undefined) {
          size = 2;
      }
      let pad_number = num + "";
  ...
  public getDateObj(quando : any = 0) : any {
  ...
  public formata_cpf(cpf : string) : string {
      // Formata cpf para ddd.ddd.ddd-dd
      ...
      // formata em 11 algarismos liderados por 0
      cpf = '00000000000' + cpf;
  ...
  public formata_cnpj(cnpj : string) : string {
      ...
      // formata em 14 algarismos liderados por 0
  ...
  public limpa_string_numerica (str : any) : string {
      // limpa qq caracter não numérico
      let str2 = String(str);
  ...
  public formata_site(site : string) : string {
      if (site == undefined ) {
          return '';
      }
      site = site.trim();
  ...
  public formata_site_com_protocolo(site : string) : string {
      let is_https = false;
      if (site == undefined ) { return ''; }

      let regex = /(https)/;
      let x = regex.exec(site);
      if (x) { is_https = true; }

      site = this.formata_site(site);
      if (is_https){
          return 'https://' + site;
      }
      else{
  ...
  public open_url(parametro : string) {
      window.open(this.formata_site_com_protocolo(parametro), '_blank');
  }

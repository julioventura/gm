...
export class DetailComponent implements OnInit {
    ...
    public download_imagem_do_firestore(){
        if(this.dados.selected.img_url && this.dados.selected.local_da_imagem == 'firestore' && this.dados.selected.img_url.substr(0,4)=='user'){
            this.filePath = this.dados.selected.img_url;
            this.local_da_imagem = this.dados.selected.local_da_imagem ? this.dados.selected.local_da_imagem : '';
